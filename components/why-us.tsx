...
export function WhyUs() {
  ...
  return (
    <section id="why-us" className="relative py-28 px-4 sm:px-6 lg:px-8 bg-zinc-950 border-t border-white/5 overflow-hidden">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 space-y-6">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-500/10 border border-sky-400/20 text-sky-400 text-xs font-mono">
                ...
                <div className="flex-1 w-full">
                  <div className="relative rounded-3xl p-1 bg-gradient-to-br from-white/15 via-white/5 to-transparent shadow-2xl overflow-hidden group">
                    <div className="relative rounded-[22px] bg-black/80 border border-white/10 p-8 min-h-[280px] sm:min-h-[320px] flex flex-col justify-between overflow-hidden backdrop-blur-xl">
                      <div className="absolute top-0 right-0 w-64 h-64 bg-sky-400/10 rounded-full blur-3xl group-hover:scale-125 transition-transform duration-700 pointer-events-none" />

                      <div className="flex items-center justify-between z-10">
                        <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-sky-400">
                      ...
                      <div className="z-10 mt-12">
                        <div className="p-4 rounded-xl bg-white/5 border border-white/10 space-y-2 backdrop-blur-md">
                          ...
                          <div className="h-1.5 w-full bg-white/10 rounded-full overflow-hidden">
                            <div className="h-full bg-sky-400 rounded-full w-4/5 animate-pulse" />
                          </div>
                        </div>
                      </div>
                    </div>
